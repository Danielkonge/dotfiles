...
vim.keymap.set('n', '<leader>gdf', '<Cmd>DiffviewFileHistory %<CR>', { silent = true, desc = 'Diffview [F]ile History' })
vim.keymap.set('n', '<leader>gdt', '<Cmd>DiffviewToggleFiles<CR>', { silent = true, desc = 'Diffview [T]oggle Files' })
